...
const CreateJobForm = () => {
    ...
    return (
        <>
                        ...
                        <div className="modal-content">
                            <div className="modal-header" style={{ backgroundColor: '#e99b9b', textAlign: 'center', position: 'relative' }}>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="70" fill="currentColor" class="bi bi-check-circle" viewBox="0 0 16 16" style={{ marginRight: '5px' }}>
                                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                                        <path d="m10.97 4.97-.02.022-3.473 4.425-2.093-2.094a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05"/>
                                    </svg>
                                    <h4 style={{ margin: '0', color: 'black' }}>{errorMessage}</h4>
                                </div>
                            </div>
                            <div className="modal-body" style={{ padding: '10px' }}>
                                <div style={{ display: 'flex', justifyContent: 'center' }}>
                                    <button type="button" className="btn btn-secondary me-2" onClick={addMoreJobs}>Add More Jobs</button>
                                    <button type="button" className="btn btn-primary" onClick={viewMyPostedJobs}>View Posted Jobs</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="container-fluid" style={{ minHeight: '80vh', backgroundColor: 'white' }}>
                <div className="row">
                    <UserNavigation />
                                ...
                                <form onSubmit={handleFormSubmit}>
                                    <div className="form-group row mb-3">
                                        <div className="col">
                                            ...
                                            <input type="text" name="position_title" value={formData.position_title} onChange={handleChange} className="form-control" placeholder="Position Title" required />
                                        </div>
                                        <div className="col">
                                            <label htmlFor="company_name" className="form-label">Company Name</label>
                                            <input type="text" name="company_name" value={formData.company_name} onChange={handleChange} className="form-control" placeholder="Company Name" required />
                                        </div>
                                    </div>
