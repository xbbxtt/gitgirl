...
function Home() {
    return (
        <div>
            ...
            <div className="row">
                <div className="col">
                    <div className="card text-white bg-primary mb-3 d-flex justify-content-around">
                        <div
                            className="card-body"
                            style={{
                                display: 'flex',
                ...
                <div className="col">
                    <div
                        className="card text-white bg-primary mb-0"
                        style={{ padding: '30px' }}
                    >
                        <div className="card-body">
            ...
            <div className="row">
                <div className="col">
                    <div
                        className="card text-white bg-secondary mb-3 d-flex justify-content-around"
                        style={{ padding: '50px' }}
                    >
                        <div className="card-body">
                ...
                <div className="col">
                    <div className="card text-white bg-secondary mb-0">
                        <div
                            className="card-body"
                            style={{
                                display: 'flex',
